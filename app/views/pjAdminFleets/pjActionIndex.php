...
if (isset($tpl['status']))
{
	...
	<div class="b10">
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="float_left pj-form r10">
			<input type="hidden" name="controller" value="pjAdminFleets" />
			<input type="hidden" name="action" value="pjActionCreate" />
			<input type="submit" class="pj-button" value="<?php __('btnAddVehicle'); ?>" />
		</form>
	...
	var pjGrid = pjGrid || {};
	var myLabel = myLabel || {};
	myLabel.thumb = "<?php __('lblThumb', false, true); ?>";
	myLabel.fleet = "<?php __('lblFleet', false, true); ?>";
	myLabel.passengers = "<?php __('lblPassengers', false, true); ?>";
	myLabel.luggage = "<?php __('lblLuggage', false, true); ?>";
	myLabel.count = "<?php __('lblCount', false, true); ?>";
