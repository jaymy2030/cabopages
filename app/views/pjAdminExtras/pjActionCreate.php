	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminExtras&amp;action=pjActionCreate" method="post" id="frmCreateExtra" class="form pj-form" autocomplete="off">
		...
		<p>
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				...
				<input type="text" id="price" name="price" class="pj-form-field number w108 required"  data-msg-required="<?php __('tr_field_required');?>"/>
			</span>
		</p>
		<p>
			<label class="title"><?php __('lblPricePerPerson'); ?></label>
			<span class="inline_block t5">
				<input type="checkbox" id="price_per_person" name="price_per_person"/>
			</span>
		</p>
		<p>
