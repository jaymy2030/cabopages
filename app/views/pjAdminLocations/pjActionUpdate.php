...
if (isset($tpl['status']))
{
	...
	<?php pjUtil::printNotice(__('infoUpdateLocationTitle2', true, false), __('infoUpdateLocationDesc2', true, false)); ?>
	
	<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) :?>
	<div class="multilang"></div>
	<?php endif; ?>
	
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminLocations&amp;action=pjActionUpdate" method="post" id="frmUpdateLocation" class="form pj-form">
		...
		<p>
			...
			<span class="inline_block">
				<input id="address" name="address" value="<?php echo pjSanitize::html($tpl['arr']['address']); ?>" class="pj-form-field w400 required" data-msg-required="<?php __('tr_field_required');?>"/>
			</span>
		</p>
		<p>
